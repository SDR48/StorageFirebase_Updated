...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.ViewHolder> {
    ...
    public MusicAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
    ...
    public MusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MusicAdapter.ViewHolder(itemview);
    }
    ...
    public void onBindViewHolder(@NonNull final MusicAdapter.ViewHolder holder, final int position) {
        ...
        Glide.with(context).asBitmap().load(R.drawable.audioimg).into(holder.thumbnail);
        ...
        holder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                storageReference.child(user).child("My Music").child(name).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
                        reference.child(user).child("My Music").child(name1).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
