...
public void update(String filename, String url)
{
    ...
    public ImgAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        Glide.with(context).asBitmap().load(urls.get(position)).into(holder.thumbnail);
        ...
        holder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                storageReference.child(user).child("My Pictures").child(name).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
                        reference.child(user).child("My Pictures").child(name1).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
